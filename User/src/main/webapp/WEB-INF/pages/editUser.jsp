						...
						<div class="card-body p-md-5">
							<div class="row justify-content-center">
								<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
									...
									<p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Edit My Info</p>

									<form:form class="mx-1 mx-md-4" action="/editUser"
										method="post" modelAttribute="user">

										<div class="d-flex flex-row align-items-center mb-4">
											<i class="fas fa-user fa-lg me-3 fa-fw"></i>
											<c:set var="error" scope="session"
												value="${userExistsError}" />
											<c:if test="${error != null}">
												<div class=" form-outline flex-fill mb-0 alert alert-danger " role="alert">${userExistsError}</div>
											</c:if></div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<i class="fas fa-user fa-lg me-3 fa-fw"></i>
												<div class="form-outline flex-fill mb-0">
													<form:input path="email" type="text" id="form3Example1c"
														class="form-control" />
											...
											<div class="d-flex flex-row align-items-center mb-4">
												<i class="fas fa-user fa-lg me-3 fa-fw"></i>
												<div class="form-outline flex-fill mb-0">
													<form:input path="phone" type="text" id="form3Example1c"
														class="form-control" />
											...
											<div
												...
												<a href="/index" class="btn btn-primary btn-lg mt-3">
													Cancel</a>
											</div>
									</form:form>
